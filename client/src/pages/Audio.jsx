...
const Audio = () => {
  ...
  const loadData = async () => {
    try {
      const api = `${WEB_URL}/product/audio?category=Audio`;
  ...
  return(
    ...
    <div style={{marginTop:"90px"}}>
      <div style={{fontSize:"24px",fontWeight: "bold",marginBottom:"10px" }}>Latest Earbuds and Headphones</div>
      Explore the latest audio from OPPO India.
    </div>
    </center>
