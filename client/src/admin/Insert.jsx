...
const Insert = () => {
    ...
    const categories = {
        Phone: ['OPPO Reno13 Pro 5G', 'OPPO Reno13 5G', 'OPPO Find X8 Pro', 'OPPO Find X8'],
        Audio: ['OPPO Enco Air3 Pro', 'OPPO Enco Buds2', 'OPPO Enco Air2 Pro', 'OPPO MH166 Earphone'],
        Tablets: ['OPPO Pad Air'],
        Acessory: ['OPPO SUPERVOOC 80W Power Adapter', 'OPPO SUPERVOOC 45W Power Adapter', 'OPPO 80W SUPERVOOC Car Charger', 'Gaming & Accessories', 'Smart Home & IoT Devices', 'OPPO VOOC Type-C Data Cable 1M'],
    };
